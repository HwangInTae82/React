...
const imgUrl = "https://i.namu.wiki/i/I-tU2FVuexxyE6qm-xftr7_2KYUIr21P7Q11UFjBtDtcqy865f69aILqAXGP3j47MPSJV2Ne-3NczjBDARVoQQ.webp";
...
function getImg(){
  return   <img src={imgUrl} alt="트랄라레로 트랄랄라" width={100} />
}
      ...
      <ul>
          {
            ...
            <li key={key}> {/*반복되는 요소안에는 무조건 key 라는 속성이 필요함*/}
                {key} : {loginUser[key]}
            </li>
          )}
          ...
          <ul>
            <li>
              <img src={imgUrl} alt="트랄라레로 트랄랄라" width={100} />
            </li>
          </ul>
